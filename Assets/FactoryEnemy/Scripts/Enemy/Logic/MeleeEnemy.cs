...
namespace Nevermindever.Enemy.Logic {
    public class MeleeEnemy : Enemy {
        ...
        public MeleeEnemy( int damage, float fireRate, Animator animator, Transform playerTransform, IDamageable playerDamageable,float fireRange,float attackCooldown)
